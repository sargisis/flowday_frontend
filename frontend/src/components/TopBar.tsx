        ...
        <>
            <div className="flex items-center justify-between py-4 px-8 border-b border-zinc-200 dark:border-white/5 bg-white/80 dark:bg-background/80 sticky top-0 z-40 backdrop-blur-md">
                ...
                >
                    ...
                    <div
                        className="block w-full pl-10 pr-4 py-2.5 bg-zinc-100 dark:bg-zinc-900/50 border border-zinc-300 dark:border-white/10 rounded-xl text-sm text-zinc-600 dark:text-zinc-500 transition-all hover:bg-zinc-200 dark:hover:bg-zinc-900 hover:border-blue-500/30 dark:hover:border-indigo-500/30 select-none"
